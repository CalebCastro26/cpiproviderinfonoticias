		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mantenimiento Información Noticia",
									"targetURL": "#cpiproviderinfonoticia-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cpiproviderinfonoticia-display": {
								"semanticObject": "cpiproviderinfonoticia",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cp.iprovider.info.noticia",
									"url": sap.ui.require.toUrl("cp/iprovider/info/noticia")
								}
							}
						}
					}
